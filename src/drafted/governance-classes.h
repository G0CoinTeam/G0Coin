 ...
 *
 *   // network
 *   CG0CoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.g0coin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CG0CoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: G0CoinNetwork
// //   -- signature requirements : Key1(User)
// class CG0CoinNetworkVariable : public CGovernanceObject
// {
// private:
