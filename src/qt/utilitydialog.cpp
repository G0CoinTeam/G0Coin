    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("G0Coin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About G0Coin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  g0coin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the G0Coin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 G0COIN, 0.1 G0COIN, 1 G0COIN and 10 G0COIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://g0cointeam.atlassian.net/wiki/display/DOC/PrivateSend\">https://g0cointeam.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("G0Coin Core is shutting down...") + "<br /><br />" +
