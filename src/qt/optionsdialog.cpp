    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("G0COIN-light"), QVariant("light"));
    ui->theme->addItem(QString("G0COIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("G0COIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("G0COIN-traditional"), QVariant("trad"));
