    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("G0Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a G0Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and g0coin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About G0Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about G0Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for G0Coin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your G0Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified G0Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a g0coin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the G0Coin Core help message to get a list with possible G0Coin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("G0Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to G0Coin network", "", count));
}
...
{
    QString strTitle = tr("G0Coin Core"); // default title
