...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("G0Coin Core g0coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  g0coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded g0coin transaction") + "\n" +
              "  g0coin-tx [options] -create [commands]   " + _("Create hex-encoded g0coin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded g0coin transaction
