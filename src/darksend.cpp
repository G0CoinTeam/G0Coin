...
{
    if(fLiteMode) return; // ignore all G0Coin related functionality
...
/*
    ...
    allow endless transaction that would bloat G0Coin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("g0coin-privatesend");
