...
G0Coin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as G0Coin Core, where everyone uses
...
pay attention to for reviewers of G0Coin Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: G0Coin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
