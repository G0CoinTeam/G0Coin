...
Only requiring some minor changes is g0coin.cpp.
...
Changes to g0coin.cpp
----------------------
g0coin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
