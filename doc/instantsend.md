...
This mechanism has been integrated into Bitcore-Node-G0Coin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/G0CoinTeam/insight-api-g0coin#web-socket-api](https://github.com/G0CoinTeam/insight-api-g0coin#web-socket-api) 
* API: [https://github.com/G0CoinTeam/insight-api-g0coin#instantsend-transactions](https://github.com/G0CoinTeam/insight-api-g0coin#instantsend-transactions) 
...
By default, the G0Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the G0Coin Core daemon:
