...
G0Coin Core version 0.12.0 is now available from:

  https://g0cointeam.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/G0CoinTeam/G0Coin/issues
...
backwards-compatible with pre-0.12 versions of G0Coin Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/g0coin/).
